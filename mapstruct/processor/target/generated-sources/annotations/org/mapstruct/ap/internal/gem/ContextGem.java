...
public class ContextGem implements Gem {

    private final boolean isValid;
    private final AnnotationMirror mirror;

    private ContextGem( BuilderImpl builder ) {
        isValid = true;
    ...
    public static ContextGem  instanceOn(Element element) {
        return build( element, new BuilderImpl() );
    }

    public static ContextGem instanceOn(AnnotationMirror mirror ) {
        return build( mirror, new BuilderImpl() );
    }

    public static  <T> T  build(Element element, Builder<T> builder) {
        AnnotationMirror mirror = element.getAnnotationMirrors().stream()
            .filter( a ->  "org.mapstruct.Context".contentEquals( ( ( TypeElement )a.getAnnotationType().asElement() ).getQualifiedName() ) )
            .findAny()
            .orElse( null );
    ...
    public interface Builder<T> {
         ...
         *
         * @return the {@link Builder} for this gem, representing {@link ContextGem}
         */
    ...
    private static class BuilderImpl implements Builder<ContextGem> {
