...
public class MappingControlsGem implements Gem {

    private final GemValue<List<MappingControlGem>> value;
    private final boolean isValid;
    private final AnnotationMirror mirror;

    private MappingControlsGem( BuilderImpl builder ) {
    ...
    * accessor
    *
    * @return the {@link GemValue} for {@link MappingControlsGem#value}
    */
    public GemValue<List<MappingControlGem>> value( ) {
        return value;
    }
    ...
    public static MappingControlsGem  instanceOn(Element element) {
        return build( element, new BuilderImpl() );
    }

    public static MappingControlsGem instanceOn(AnnotationMirror mirror ) {
        return build( mirror, new BuilderImpl() );
    }

    public static  <T> T  build(Element element, Builder<T> builder) {
        AnnotationMirror mirror = element.getAnnotationMirrors().stream()
            .filter( a ->  "org.mapstruct.control.MappingControls".contentEquals( ( ( TypeElement )a.getAnnotationType().asElement() ).getQualifiedName() ) )
            .findAny()
            .orElse( null );
    ...
    public static <T> T build(AnnotationMirror mirror, Builder<T> builder ) {
        ...
        for ( String methodName : defaultValues.keySet() ) {
            ...
            if ( "value".equals( methodName ) ) {
                builder.setValue( GemValue.createArray( values.get( methodName ), defaultValues.get( methodName ), MappingControlGem::instanceOn ) );
            }
        }
    ...
    public interface Builder<T> {
       ...
       /**
        * Sets the {@link GemValue} for {@link MappingControlsGem#value}
        *
        * @return the {@link Builder} for this gem, representing {@link MappingControlsGem}
        */
        Builder setValue(GemValue<List<MappingControlGem>> methodName );
    ...
    private static class BuilderImpl implements Builder<MappingControlsGem> {

        private GemValue<List<MappingControlGem>> value;
        private AnnotationMirror mirror;

        public Builder setValue(GemValue<List<MappingControlGem>> value ) {
            this.value = value;
            return this;
        }
        ...
        public MappingControlsGem build() {
            return new MappingControlsGem( this );
        }
    }
