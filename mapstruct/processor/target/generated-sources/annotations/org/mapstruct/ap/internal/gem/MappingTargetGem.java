...
public class MappingTargetGem implements Gem {
    ...
    private MappingTargetGem( BuilderImpl builder ) {
        isValid = true;
    ...
    public static MappingTargetGem instanceOn(AnnotationMirror mirror ) {
        return build( mirror, new BuilderImpl() );
    }

    public static  <T> T  build(Element element, Builder<T> builder) {
        AnnotationMirror mirror = element.getAnnotationMirrors().stream()
            .filter( a ->  "org.mapstruct.MappingTarget".contentEquals( ( ( TypeElement )a.getAnnotationType().asElement() ).getQualifiedName() ) )
            .findAny()
            .orElse( null );
    ...
    public interface Builder<T> {
         ...
         *
         * @return the {@link Builder} for this gem, representing {@link MappingTargetGem}
         */
