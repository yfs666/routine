...
public class AfterMappingGem implements Gem {
    ...
    private AfterMappingGem( BuilderImpl builder ) {
        isValid = true;
    ...
    public static AfterMappingGem instanceOn(AnnotationMirror mirror ) {
        return build( mirror, new BuilderImpl() );
    }

    public static  <T> T  build(Element element, Builder<T> builder) {
        AnnotationMirror mirror = element.getAnnotationMirrors().stream()
            .filter( a ->  "org.mapstruct.AfterMapping".contentEquals( ( ( TypeElement )a.getAnnotationType().asElement() ).getQualifiedName() ) )
            .findAny()
            .orElse( null );
    ...
    public interface Builder<T> {
         ...
         *
         * @return the {@link Builder} for this gem, representing {@link AfterMappingGem}
         */
