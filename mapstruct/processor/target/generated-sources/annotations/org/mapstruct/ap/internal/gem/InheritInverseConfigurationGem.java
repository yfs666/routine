...
public class InheritInverseConfigurationGem implements Gem {
    ...
    private InheritInverseConfigurationGem( BuilderImpl builder ) {
    ...
    * accessor
    *
    * @return the {@link GemValue} for {@link InheritInverseConfigurationGem#name}
    */
    ...
    public static InheritInverseConfigurationGem instanceOn(AnnotationMirror mirror ) {
        return build( mirror, new BuilderImpl() );
    }

    public static  <T> T  build(Element element, Builder<T> builder) {
        AnnotationMirror mirror = element.getAnnotationMirrors().stream()
            .filter( a ->  "org.mapstruct.InheritInverseConfiguration".contentEquals( ( ( TypeElement )a.getAnnotationType().asElement() ).getQualifiedName() ) )
            .findAny()
            .orElse( null );
    ...
    public interface Builder<T> {
       ...
       /**
        * Sets the {@link GemValue} for {@link InheritInverseConfigurationGem#name}
        *
        * @return the {@link Builder} for this gem, representing {@link InheritInverseConfigurationGem}
        */
