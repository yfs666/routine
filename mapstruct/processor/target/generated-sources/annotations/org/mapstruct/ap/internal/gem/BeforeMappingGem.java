...
public class BeforeMappingGem implements Gem {
    ...
    private BeforeMappingGem( BuilderImpl builder ) {
        isValid = true;
    ...
    public static BeforeMappingGem instanceOn(AnnotationMirror mirror ) {
        return build( mirror, new BuilderImpl() );
    }

    public static  <T> T  build(Element element, Builder<T> builder) {
        AnnotationMirror mirror = element.getAnnotationMirrors().stream()
            .filter( a ->  "org.mapstruct.BeforeMapping".contentEquals( ( ( TypeElement )a.getAnnotationType().asElement() ).getQualifiedName() ) )
            .findAny()
            .orElse( null );
    ...
    public interface Builder<T> {
         ...
         *
         * @return the {@link Builder} for this gem, representing {@link BeforeMappingGem}
         */
