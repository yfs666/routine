...
public class JavaTypeResolverDefaultImpl implements JavaTypeResolver {
    ...
    public FullyQualifiedJavaType calculateJavaType(
        ...
        // 把isDelete字段全部改成Boolean类型
        if (introspectedColumn.getJdbcType() == Types.TINYINT && introspectedColumn.getActualColumnName().startsWith("is_delete")) {
            jdbcTypeInformation = typeMap
                    .get(Types.BOOLEAN);
        }
