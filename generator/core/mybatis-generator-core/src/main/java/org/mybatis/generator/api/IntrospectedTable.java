...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_LIST_BY_IDS_STATEMENT_ID,
        ATTR_LIST_BY_PRIMARY_KEY_STATEMENT_ID,
    ...
    protected void calculateXmlAttributes() {
        ...
        setSelectByExampleStatementId("getByExample"); //$NON-NLS-1$
        setSelectByExampleWithBLOBsStatementId("selectByExampleWithBLOBs"); //$NON-NLS-1$
        setSelectByPrimaryKeyStatementId("getById"); //$NON-NLS-1$
        setListByIdsStatementId("listByIds"); //$NON-NLS-1$
        ...
        setUpdateByPrimaryKeyStatementId("updateByIdAll"); //$NON-NLS-1$
    ...
    public void setListByIdsStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_LIST_BY_IDS_STATEMENT_ID, s);
    }
    ...
    public String getListByIdsStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_LIST_BY_IDS_STATEMENT_ID);
    }
