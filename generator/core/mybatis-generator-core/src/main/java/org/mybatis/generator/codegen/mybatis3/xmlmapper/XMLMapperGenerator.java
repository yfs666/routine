...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.ListByIdsElementGenerator;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected void addListByIdsElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new ListByIdsElementGenerator();
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
