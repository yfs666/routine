...
public class MyBatis3FormattingUtilities {
    ...
    public static String getBatchParameterClause(String itemPre, IntrospectedColumn introspectedColumn) {
        return getBatchParameterClause(itemPre, introspectedColumn, null);
    }

    public static String getBatchParameterClause(String itemPre, IntrospectedColumn introspectedColumn, String prefix) {
