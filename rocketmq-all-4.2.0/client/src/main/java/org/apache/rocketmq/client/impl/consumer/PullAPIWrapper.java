...
public class PullAPIWrapper {
     ...
     * @param maxNums 本次拉取最大消息条数，默认是32条
     * @param sysFlag 拉取系统标记
     * @param commitOffset 当前MQ的消费进度（内存中）
...
//       根据brokerName、brokerId从MQClientInstance中获取Broker地址，在整个RocketMQ Broker的部署结构中，相同Broker
//       构成主从结构，其BrokerId会不一样，在每次拉取消息后，会给出一个建议，下次拉取从主节点还是从节点拉取
...
//                如果消息过滤模式为类过滤，则需要根据主题名称、broker地址找到注册在Broker上d FilterServer 地址，从FilterServer上拉取消息
