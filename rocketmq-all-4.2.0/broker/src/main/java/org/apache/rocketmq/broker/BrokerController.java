...
public class BrokerController {
    ...
    /**
     * Consumer端的消费offset的集中管理，主要关系是topic、group、queueId、offset
     */
    private final ConsumerOffsetManager consumerOffsetManager;
    /**
     * consumer的管理和维护，提供consumer的注册、取消、关闭等，主要关系是group、consumerGroupInfo
     */
    ...
    /**
     * 针对consumer的请求拉取消息的事件处理，基于netty框架，解析并执行内部业务功能，最终将数据返回
     */
    ...
    /**
     * 新消息到达的业务监听，联合pullRequestHoldService进行消息到达的通知功能
     */
    private final MessageArrivingListener messageArrivingListener;
    /**
     * broker对请求处理的封装类，处理对应的操作，主要有通知、重置、转换状态等
     */
    ...
    /**
     * broker请求外部的封装，主要是通过netty的底层通信完成和ns的交互
     */
    private final BrokerOuterAPI brokerOuterAPI;
    private final ScheduledExecutorService scheduledExecutorService = Executors.newSingleThreadScheduledExecutor(new ThreadFactoryImpl(
        "BrokerControllerScheduledThread"));
    /**
     * slave的同步操作，如果broker是slave角色，执行同步操作，主要同步元数据信息
     */
    private final SlaveSynchronize slaveSynchronize;
    /**
     * 下面是各种同步阻塞队列，主要是处理发送、拉取、查询等操作，多线程操作，提供并发能力
     */
    ...
    /**
     * broker的两级服务，一个是快速提供服务操作，只是没有pull事件的处理
     */
    ...
    /**
     * broker的快速失败策略，主要针对系统的请求，开启功能及时清理过期的请求，避免请求堆积
     */
...
//        加载历史数据，如果是新启动，则初始化数据，如果是非首次启动，把硬盘中的数据加载到内存中
