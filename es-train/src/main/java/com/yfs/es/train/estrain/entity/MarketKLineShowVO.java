...
public class MarketKLineShowVO {
    ...
    public MarketKLineShowVO(List<KLineVO> kSum, List<KLineVO> k60x, List<KLineVO> k000, List<KLineVO> k002, List<KLineVO> k300, List<KLineVO> k688) {
        this.kSum = kSum;
        this.k60x = k60x;
        this.k000 = k000;
        this.k002 = k002;
        ...
        this.k688.forEach(KLineVO::wrapPercent);
        ...
        Collections.sort(this.k688);
        this.k002_1 = this.k002.subList(0, this.k002.size() / 2);
        this.k002_2 = this.k002.subList(this.k002.size() / 2, this.k002.size());
        this.k60x_1 = this.k60x.subList(0, this.k60x.size() / 3);
        this.k60x_2 = this.k60x.subList(this.k60x.size() / 3, this.k60x.size() * 2 / 3);
        this.k60x_3 = this.k60x.subList(this.k60x.size() * 2 / 3, this.k60x.size());
    }
